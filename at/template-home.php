				...
				<div class="uk-overlay-panel uk-container uk-container-center uk-flex uk-flex-middle uk-position-relative">
					<div class="uk-grid">
						...
						<div class="uk-width-large-1-2">
							<?php if($slider_image):?><img src="<?php echo $slider_image ; ?>"><?php endif;?>
						</div>
					</div>
				</div>
			</li>
		...
		<section class="main">
			<div class="uk-block uk-text-center site-features">
				<div class="uk-container uk-container-center">
					...
					<div class="uk-grid uk-grid-width-large-1-5 section_offer" data-uk-margin="{cls:'uk-margin-top'}">
						...
						<div class="uk-panel uk-panel-header">
                            ...
                            <a class="uk-position-cover" href="<?php the_sub_field('link'); ?>"></a>
						</div>
						<?php endwhile; ?>
					</div>
					<?php endif; ?>
